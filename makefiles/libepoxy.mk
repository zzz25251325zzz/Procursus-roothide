...
libepoxy-setup: setup
	$(call DOWNLOAD_FILE,$(BUILD_SOURCE)/libepoxy-$(LIBEPOXY_VERSION).tar.xz, https://download.gnome.org/sources/libepoxy/$(shell echo $(LIBEPOXY_VERSION) | cut -d. -f-2)/libepoxy-$(LIBEPOXY_VERSION).tar.xz)
